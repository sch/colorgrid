...
var _user$project$Main$quote = function (str) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'\"',
		A2(_elm_lang$core$Basics_ops['++'], str, '\"'));
};
var _user$project$Main$systemMonospacedFonts = A2(
	_elm_lang$core$String$join,
	', ',
	{
		ctor: '::',
		_0: _user$project$Main$quote('SF Mono'),
		_1: {
			ctor: '::',
			_0: _user$project$Main$quote('Monaco'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$quote('Inconsolata'),
				_1: {
					ctor: '::',
					_0: _user$project$Main$quote('Fira Mono'),
					_1: {
						ctor: '::',
						_0: _user$project$Main$quote('Droid Sans Mono'),
						_1: {
							ctor: '::',
							_0: _user$project$Main$quote('Source Code Pro'),
							_1: {
								ctor: '::',
								_0: 'monospace',
								_1: {ctor: '[]'}
...
var _user$project$Main$viewConnections = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.connectedUsers;
	var message = function () {
		var _p2 = _p3;
		if (_p2 === 1) {
			return '1 user is connected';
		} else {
			return A2(
				_elm_lang$core$Basics_ops['++'],
	...
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'font-family', _1: _user$project$Main$systemMonospacedFonts},
							_1: {
								ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(_p1.lastResponse),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$systemFonts = A2(
	_elm_lang$core$String$join,
	', ',
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$quote('Segoe UI'),
				_1: {
					ctor: '::',
					_0: 'Roboto',
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$quote('Apple Color Emoji'),
									_1: {
										ctor: '::',
										_0: _user$project$Main$quote('Segoe UI Emoji'),
										_1: {
											ctor: '::',
											_0: _user$project$Main$quote('Segoe UI Symbol'),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$toColor = function (_p4) {
	var _p5 = _p4;
	return A3(_elm_lang$core$Color$hsl, _p5.hue, _p5.saturation, _p5.lightness);
};
var _user$project$Main$colorMessage = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'color:',
		_eskimoblood$elm_color_extra$Color_Convert$colorToCssHsl(
			_user$project$Main$toColor(model)));
};
var _user$project$Main$viewHsl = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgba(255, 255, 255, 0.2)'},
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'padding', _1: '20px 30px'},
								_1: {
									ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'font-family', _1: _user$project$Main$systemFonts},
														_1: {ctor: '[]'}
													}
												}
											}
		...
		{
			ctor: '::',
			_0: _user$project$Main$viewConnections(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewHsl(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$endpoint = 'ws://localhost:4000/ws';
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {window: a, hue: b, saturation: c, lightness: d, affecting: e, connectedUsers: f, lastResponse: g};
	});
var _user$project$Main$Lightness = {ctor: 'Lightness'};
var _user$project$Main$Saturation = {ctor: 'Saturation'};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p6.ctor) {
			...
			case 'MouseMove':
				var _p7 = _p6._0;
				var lightness = _elm_lang$core$Native_Utils.eq(model.affecting, _user$project$Main$Lightness) ? (1 - (_elm_lang$core$Basics$toFloat(_p7.y) / _elm_lang$core$Basics$toFloat(model.window.height))) : model.lightness;
				var saturation = _elm_lang$core$Native_Utils.eq(model.affecting, _user$project$Main$Saturation) ? (1 - (_elm_lang$core$Basics$toFloat(_p7.y) / _elm_lang$core$Basics$toFloat(model.window.height))) : model.saturation;
				var hue = ((_elm_lang$core$Basics$toFloat(_p7.x) / _elm_lang$core$Basics$toFloat(model.window.width)) * 2) * _elm_lang$core$Basics$pi;
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{hue: hue, lightness: lightness, saturation: saturation});
				var command = A2(
					_elm_lang$websocket$WebSocket$send,
					_user$project$Main$endpoint,
					_user$project$Main$colorMessage(newModel));
				return {ctor: '_Tuple2', _0: newModel, _1: command};
			case 'ToggleBetweenSaturationAndLightness':
				var _p8 = model.affecting;
				if (_p8.ctor === 'Saturation') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{affecting: _user$project$Main$Lightness}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{affecting: _user$project$Main$Saturation}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
...
var _user$project$Main$ServerMessage = function (a) {
	return {ctor: 'ServerMessage', _0: a};
};
var _user$project$Main$ToggleBetweenSaturationAndLightness = {ctor: 'ToggleBetweenSaturationAndLightness'};
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$mouse$Mouse$clicks(
						_elm_lang$core$Basics$always(_user$project$Main$ToggleBetweenSaturationAndLightness)),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$endpoint, _user$project$Main$ServerMessage),
						_1: {ctor: '[]'}
					}
				}
			}
